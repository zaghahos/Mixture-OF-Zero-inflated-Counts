...
#########################################################################################################################
#########################################################################################################################
ZINB_Mix_EM <- function(Y,totals,beta_0g,rho_gk,dispresiopn_parameter,P,Phi,eps=1e-8,maxiter_EM=1000){  
  N<- nrow(Y)
  G<- ncol(Y)
  K<- length(P)
  dl<- 1+eps
...
P_est<- Phi_est<- matrix(NA,nrow=S,ncol=K)

size_update<- matrix(NA,nrow=S,ncol=K)
...
for(s in 1:S){
  ...
  #########################################################################################    
  #result<- NR_G_ZINB(Y=cell_matrix,T=T,beta_0=beta_0g_cur,rho=rho_cur,Z_nk=Z_nk,U_ng=U_ngk,overdisp_para=size,criterion=1e-5,maxiter=500)
  
  elapsed[s]<- system.time({result<- ZINB_Mix_EM(Y=cell_matrix,totals=T,beta_0g=beta_0,rho_gk=rho,dispresiopn_parameter=size,P=P,Phi=Phi,eps=1e-8,maxiter_EM=1000)})["elapsed"]  
  
  #NR_Poisson_G_ZIP(Y=Y,T=T,beta_0=beta_0,rho=rho,Z_nk=Z_nk,U_ng=U_ng,K=K,criterion=1e-5,maxiter=500)
  
  
 # print(result) 
  
  P_est[s,]<- result$P
  Phi_est[s,]<- result$phi
  size_update[s,]<- result$size_est
...
SS2_B0<- SM_B0<- SS2_rho1<- SM_rho1<- SS2_rho2<- SM_rho2<- matrix(NA,nrow=S,ncol=G)

for(s in 1:S){
  SS2_B0[s,]<- (beta_0_est[s,]-beta_0)^2
  SM_B0[s,]<- abs(beta_0_est[s,]-beta_0)
  SS2_rho1[s,]<- (rho1_est[s,]-rho_1)^2
  SS2_rho2[s,]<- (rho2_est[s,]-rho_2)^2
  SM_rho1[s,]<- abs(rho1_est[s,]-rho_1)
  SM_rho2[s,]<- abs(rho2_est[s,]-rho_2)
}
#SS2_B0
#SM_B0
#SS2_rho1
...
MSE_G_B0<- apply(SS2_B0,1,mean) 
#MSE_G_B0

MAD_G_B0<- apply(SM_B0,1,median)
#MAD_G_B0


MSE_G_rho1<- apply(SS2_rho1,1,mean) 
#MSE_G_rho1


MAD_G_rho1<- apply(SM_rho1,1,median)
#MAD_G_rho1


MSE_G_rho2<- apply(SS2_rho2,1,mean) 
#MSE_G_rho2


MAD_G_rho2<- apply(SM_rho2,1,median)
#MAD_G_rho2

P_sim5_n1200<- write.csv(P_est,"E:/Thesis-Feb,March2022/Programming Project 2/ZINB_B/Scenario1/P_sim5_n1200.csv")
Phi_sim5_n1200<- write.csv(Phi_est,"E:/Thesis-Feb,March2022/Programming Project 2/ZINB_B/Scenario1/Phi_sim5_n1200.csv")
size_sim5_n1200<- write.csv(size_update,"E:/Thesis-Feb,March2022/Programming Project 2/ZINB_B/Scenario1/size_sim5_n1200.csv")
MSEG_B0_sim5_n1200<- write.csv(MSE_G_B0,"E:/Thesis-Feb,March2022/Programming Project 2/ZINB_B/Scenario1/MSEG_B0_sim5_n1200.csv")
MADG_B0_sim5_n1200<- write.csv(MAD_G_B0,"E:/Thesis-Feb,March2022/Programming Project 2/ZINB_B/Scenario1/MSEG_B0_sim5_n1200.csv")

MSEG_rho1_sim5_n1200<- write.csv(MSE_G_rho1,"E:/Thesis-Feb,March2022/Programming Project 2/ZINB_B/Scenario1/MSEG_rho1_sim5_n1200.csv")
MADG_rho1_sim5_n1200<- write.csv(MAD_G_rho1,"E:/Thesis-Feb,March2022/Programming Project 2/ZINB_B/Scenario1/MSEG_rho1_sim5_n1200.csv")

MSEG_rho2_sim5_n1200<- write.csv(MSE_G_rho2,"E:/Thesis-Feb,March2022/Programming Project 2/ZINB_B/Scenario1/MSEG_rho2_sim5_n1200.csv")
MADG_rho2_sim5_n1200<- write.csv(MAD_G_rho2,"E:/Thesis-Feb,March2022/Programming Project 2/ZINB_B/Scenario1/MSEG_rho2_sim5_n1200.csv")


V_M_sim5_n1200<- write.csv(V_M,"E:/Thesis-Feb,March2022/Programming Project 2/ZINB_B/Scenario1/V_M_sim5_n1200.csv")
elapsed_sim5_n1200<- write.csv(elapsed,"E:/Thesis-Feb,March2022/Programming Project 2/ZINB_B/Scenario1/elapsed_sim5_n1200.csv")


###############################################################################################################
boxplot(P_est,main="P")

abline(h=0.5)


boxplot(Phi_est,main="Phi")
abline(h=0.1)
abline(h=0.2)
